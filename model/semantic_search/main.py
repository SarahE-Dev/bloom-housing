...
def add_provider_endpoint():
    ...
    try:
        ...
        logger.info(f"New embedding generated: {new_embedding}")

        # use lock context manager to ensure thread-safe access
        with data_lock:
            ...
            # Update the global variables for the /search endpoint to use immediately
